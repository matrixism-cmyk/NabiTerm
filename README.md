...
> 📢 **2026-09-19 — nabiTerm is now freeware.** Free to use exactly as before.
> Rights granted with v0.1.528 and earlier remain in effect. Terms: [`LICENSE`](LICENSE).
...
nabiTerm is **freeware**. Individuals, companies and public institutions may use it free of
charge on any number of machines, including at work. There is no license fee. Full terms are
in [`LICENSE`](LICENSE).

- **Download**: <https://github.com/matrixism-cmyk/NabiTerm/releases> · <https://nabisori.kr>
- **Bug reports and requests**: open an [issue](https://github.com/matrixism-cmyk/NabiTerm/issues)
- **Security reports**: see [`SECURITY.md`](SECURITY.md)
- The names and logos "nabiTerm" / "나비텀" are separately protected.

Bundled open source components and their licenses are listed in-app under **Help ▸ Open Source**
