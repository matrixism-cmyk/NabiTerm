...
> v0.1.446 이하에서 설치한 경우 자동 업데이트가 구 저장소([NabiTermPub](https://github.com/matrixism-cmyk/NabiTermPub/releases))를 확인합니다 — 전환기 동안 릴리스를 양쪽에 게시하므로 그대로 업데이트하면 새 저장소를 바라보는 버전으로 자연히 넘어옵니다.
