...
> 📢 **2026-09-19 — 나비텀은 프리웨어가 되었습니다.** 무료로 쓰시는 것은 그대로입니다.
> v0.1.528 이하에 드린 권리는 그대로 유효합니다. 사용권은 [`LICENSE`](LICENSE).
...
나비텀은 **프리웨어**입니다. 개인·기업·공공기관 누구나 대수 제한 없이 무료로 쓰실 수 있고,
업무에 쓰셔도 됩니다. 사용료는 없습니다. 전문은 [`LICENSE`](LICENSE) 에 있습니다.

- **내려받기**: <https://github.com/matrixism-cmyk/NabiTerm/releases> · <https://nabisori.kr>
- **버그 신고·건의**: [이슈](https://github.com/matrixism-cmyk/NabiTerm/issues)
- **보안 취약점 신고**: [`SECURITY.md`](SECURITY.md)
- "nabiTerm/나비텀" 이름·로고에 대한 권리는 따로 보호됩니다.

함께 담은 오픈소스 구성요소와 각 라이선스는 앱 안 **도움말 ▸ 오픈소스** 화면과
