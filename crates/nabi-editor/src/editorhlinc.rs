...
impl IncHl {
    pub fn new(ext: String, theme: String) -> Self {
    ...
    pub fn job(&mut self, text: &str, fsize: f32, a: &Assets) -> LayoutJob {
...
pub fn job(id: u64, text: &str, ext: &str, fsize: f32) -> LayoutJob {
