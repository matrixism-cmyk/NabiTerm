...
pub fn strip_ansi(t: &str) -> String {
    let b = t.as_bytes();
    let mut out = String::with_capacity(t.len());
    let mut i = 0;
    while i < b.len() {
...
pub fn unwrap_paragraphs(t: &str) -> String {
...
pub fn texttools_menu(ui: &mut egui::Ui, lang: Lang) -> Option<fn(&str) -> String> {
