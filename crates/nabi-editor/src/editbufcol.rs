...
impl DispLine {
    pub fn new(src: &str, tab: usize) -> Self {
    ...
    pub fn col(&self, src: usize) -> usize {
    ...
    pub fn to_src(&self, disp: usize) -> usize {
    ...
    pub fn src_at_col(&self, col: usize) -> usize {
