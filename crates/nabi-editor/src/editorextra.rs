...
pub fn apply_pending_cursor(ui: &egui::Ui, id: egui::Id, doc: &mut crate::editor::EditorDoc) {
...
pub fn unicode_word_dblclick(ui: &egui::Ui, out: &egui::text_edit::TextEditOutput, text: &str) {
...
pub fn word_range_at(text: &str, idx: usize) -> (usize, usize) {
...
pub fn highlight_matches(painter: &Painter, galley: &egui::Galley, origin: egui::Pos2, text: &str, query: &str, ci: bool) {
...
pub fn highlight_word(painter: &Painter, galley: &egui::Galley, origin: egui::Pos2, text: &str, idx: usize) {
    let chars: Vec<char> = text.chars().collect();
    if idx > chars.len() {
        return;
    }
...
pub fn current_line_bg(painter: &Painter, galley: &egui::Galley, origin: egui::Pos2, body_w: f32, row: usize) {
...
pub fn highlight_brackets(painter: &Painter, galley: &egui::Galley, origin: egui::Pos2, char_w: f32, text: &str, idx: usize) {
...
pub fn match_bracket(text: &str, idx: usize) -> Option<(usize, usize)> {
    let chars: Vec<char> = text.chars().collect();
