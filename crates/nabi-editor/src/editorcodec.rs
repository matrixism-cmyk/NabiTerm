...
pub fn base32_encode(t: &str) -> String {
...
pub fn base32_decode(t: &str) -> String {
...
pub fn unicode_unescape(t: &str) -> String {
    let b = t.as_bytes();
    let mut out = String::with_capacity(t.len());
    let mut i = 0;
    while i < b.len() {
...
pub fn convert_menu(ui: &mut egui::Ui, lang: Lang) -> Option<Xf> {
