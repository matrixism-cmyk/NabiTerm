...
/// 개행(`\n`)은 보존해 디코드가 정확히 왕복한다.
pub(crate) fn qp_encode(t: &str) -> String {
...
pub(crate) fn qp_decode(t: &str) -> String {
    let b = t.as_bytes();
...
pub(crate) fn base58_encode(t: &str) -> String {
...
pub(crate) fn base58_decode(t: &str) -> String {
    let s = t.trim();
...
pub(crate) fn ascii85_encode(t: &str) -> String {
...
pub(crate) fn ascii85_decode(t: &str) -> String {
...
pub(crate) fn base45_encode(t: &str) -> String {
    let mut out = String::new();
...
pub(crate) fn base45_decode(t: &str) -> String {
