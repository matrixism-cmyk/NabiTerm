...
pub(crate) fn hex_color_to_rgb(t: &str) -> String {
...
pub(crate) fn rgb_to_hex_color(t: &str) -> String {
...
pub(crate) fn hex_to_hsl(t: &str) -> String {
    let h = t.trim().trim_start_matches('#');
...
pub(crate) fn hsl_to_hex(t: &str) -> String {
...
pub(crate) fn crc32_hex(t: &str) -> String {
...
pub(crate) fn crc32_lower(t: &str) -> String {
    crc32_hex(t).to_lowercase()
}

/// SQL 문자열 리터럴로 이스케이프(`'`→`''`, 양끝 작은따옴표).
pub(crate) fn sql_escape(t: &str) -> String {
    format!("'{}'", t.replace('\'', "''"))
}

/// 정규식 메타문자 이스케이프(리터럴 검색용).
pub(crate) fn regex_escape(t: &str) -> String {
    regex::escape(t.trim_end_matches('\n'))
}

/// 점표기 IPv4 → 32비트 정수. 실패 시 원문.
pub(crate) fn ip_to_int(t: &str) -> String {
...
pub(crate) fn int_to_ip(t: &str) -> String {
...
pub(crate) fn json_sort_keys(t: &str) -> String {
...
pub(crate) fn lines_to_json_array(t: &str) -> String {
...
pub(crate) fn json_array_to_lines(t: &str) -> String {
