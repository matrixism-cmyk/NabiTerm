...
pub(crate) const TOOLS: &[Tool] = &[
    ...
    Tool {
        ...
        probe: "rust-analyzer",
        group: Group::DevTool,
        winget: Some("Rustlang.rust-analyzer"),
        fallback: None,
        remove: None,
        store_pkg: None,
    ...
    Tool {
        ...
        group: Group::DevTool,
        // npm 패키지다 — winget에는 없다. Node가 있으면 이 한 줄로 깔린다.
        winget: None,
        fallback: Some("NPM:pyright"),
        remove: None,
        store_pkg: None,
    ...
    Tool {
        id: "tsserver",
        name: "typescript-language-server (TS/JS LSP)",
        probe: "typescript-language-server",
        group: Group::DevTool,
        winget: None,
        fallback: Some("NPM:typescript-language-server typescript"),
        remove: None,
        store_pkg: None,
