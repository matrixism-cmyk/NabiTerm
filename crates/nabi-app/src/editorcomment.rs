...
pub(crate) fn line_comment_marker(ext: &str) -> &'static str {
...
pub(crate) fn toggle_line_comment(text: &str, marker: &str) -> String {
...
pub(crate) fn block_comment_markers(ext: &str) -> Option<(&'static str, &'static str)> {
...
pub(crate) fn toggle_block_comment(text: &str, open: &str, close: &str) -> String {
    let t = text.trim();
