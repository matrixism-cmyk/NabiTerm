...
impl NabiApp {
    pub fn new(cc: &CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            clip_history: Vec::new(), find_count_cache: None, session_logs: HashMap::new(), replays: Default::default(), pending_replay: None, agent_trail_open: false, denial_noticed: false, verify_skip_noticed: false,
