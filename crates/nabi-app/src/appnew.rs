...
impl NabiApp {
    pub fn new(cc: &CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            diff_pick: None, fwd_edit: None, reconnecting: HashMap::new(), reconnect_carry: None, bundle: None, reach_all: Default::default(), pruned_logs, agent_keys: None, closed_docs: Vec::new(),
            pending_split: None,
