...
pub(crate) enum MenuAction {
    ...
    RenameGroup(String, String), DisbandGroup(String), OpenKeygen, OpenEnvMgr, OpenCmdHistory, OpenSupportBundle, TestConnection(String, u16), TogglePin(String), EditNote(String), EditAutoForwards(String),
    TearOff,
    DockFloat,
    Arrange(ArrangeMode),
    TileTabs,
