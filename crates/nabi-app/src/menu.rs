...
pub(crate) enum MenuAction {
    ...
    ToggleSessionsPanel,
    ToggleQcBar,
    ToggleAiDashboard, ConnectFolder(String), OpenNabiPad, MoveSessionToGroup(String, Option<String>), RenameGroup(String, String), DisbandGroup(String), TestConnection(String, u16), TogglePin(String), EditNote(String),
    TearOff,
    DockFloat,
    Arrange(ArrangeMode),
    TileTabs,
