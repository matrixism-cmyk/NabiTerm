...
pub(crate) fn local_crumbs(path: &Path) -> Vec<(String, PathBuf)> {
...
pub(crate) fn summarize(items: impl Iterator<Item = (bool, u64)>) -> (usize, usize, u64) {
...
pub(crate) fn human_date(secs: u64) -> String {
    if secs == 0 {
        return String::new();
    }
...
pub(crate) fn human_datetime(secs: u64) -> String {
    if secs == 0 {
        return String::new();
    }
...
pub(crate) fn human_age(mtime: u64, now: u64) -> String {
    if mtime == 0 {
        return String::new();
    }
