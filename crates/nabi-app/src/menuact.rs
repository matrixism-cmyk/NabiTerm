...
impl NabiApp {
    pub(crate) fn apply(&mut self, ctx: &egui::Context, a: MenuAction) {
        match a {
            ...
            MenuAction::ToggleMark => self.toggle_scroll_mark(),
            MenuAction::PrevMark => self.jump_scroll_mark(false),
            MenuAction::NextMark => self.jump_scroll_mark(true),
            MenuAction::ClearMarks => self.clear_scroll_marks(),
            MenuAction::PrevFailed => self.jump_failed(false),
            MenuAction::NextFailed => self.jump_failed(true),
            ...
            MenuAction::StopReconnect => self.stop_all_reconnects(),
