...
pub const CATALOG_TERM: &[(&str, &str, &str, &str)] = &[
    ...
    ("sched.kind.send", "Type into pane", "분할 칸에 입력", "ペインに入力"),
    ...
    ("sched.pane", "Target pane title", "대상 분할 칸 제목", "対象ペインタイトル"),
    ("sched.pane.hint", "substring match; empty = focused pane", "부분 일치 · 비우면 포커스 분할 칸", "部分一致・空欄はフォーカスペイン"),
